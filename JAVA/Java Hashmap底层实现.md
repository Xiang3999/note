...
即HashMap的原理图是：
![img](https://picgo-w.oss-cn-chengdu.aliyuncs.com/img/20160605101246837)
...
**构造hash表时，如果不指明初始大小，默认大小为16（即Node数组大小16），如果Node[]数组中的元素达到（填充Node.length）重新调整HashMap大小 变为原来2倍大小,扩容很耗时**
...
![img](https://picgo-w.oss-cn-chengdu.aliyuncs.com/img/20160605110353076)
